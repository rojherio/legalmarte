...
--
-- Table structure for table `acc_orcamento`
--

DROP TABLE IF EXISTS `acc_orcamento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acc_orcamento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acc_cliente_id` int(11) NOT NULL,
  `acc_produto_id` int(11) NOT NULL,
  `quantidade` decimal(10,2) NOT NULL,
  ...
  `data_cadastro` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_acc_orcamento_acc_produto1_idx` (`acc_produto_id`),
  KEY `fk_acc_orcamento_acc_cliente1_idx` (`acc_cliente_id`),
  CONSTRAINT `fk_acc_orcamento_acc_cliente1` FOREIGN KEY (`acc_cliente_id`) REFERENCES `acc_cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_acc_orcamento_acc_produto1` FOREIGN KEY (`acc_produto_id`) REFERENCES `acc_produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acc_orcamento`
--

LOCK TABLES `acc_orcamento` WRITE;
/*!40000 ALTER TABLE `acc_orcamento` DISABLE KEYS */;
INSERT INTO `acc_orcamento` VALUES (1,2,1,23.33,0.00,23.00,1,'2016-11-15 17:41:33'),(7,2,6,2.22,0.00,0.00,1,'2016-11-16 21:36:17'),(8,2,1,112.00,0.00,0.00,1,'2016-11-16 21:36:27'),(9,2,5,2.00,0.00,0.00,1,'2016-11-16 21:36:33');
/*!40000 ALTER TABLE `acc_orcamento` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `acc_produto` VALUES (1,'Pontos','Pontos Acrecompras personalizados',1.00,1.00,1,'0000-00-00 00:00:00'),(2,'Pontos','50 Pontos Acrecompras',50.00,50.00,1,'0000-00-00 00:00:00'),(3,'Pontos','100 Pontos Acrecompras',100.00,100.00,1,'0000-00-00 00:00:00'),(4,'Pontos','200 Pontos Acrecompras',200.00,200.00,1,'0000-00-00 00:00:00'),(5,'Pontos','500 Pontos Acrecompras',500.00,500.00,1,'0000-00-00 00:00:00'),(6,'Pontos','750 Pontos Acrecompras',750.00,750.00,1,'0000-00-00 00:00:00'),(7,'Pontos','1000 Pontos Acrecompras',1000.00,1000.00,1,'0000-00-00 00:00:00');
...
INSERT INTO `acc_tipo_operacao` VALUES (1,'Orçamento','Orçamento de compra de Pontos','+',1,'0000-00-00 00:00:00'),(2,'Compra','Compra de Pontos','+',1,'0000-00-00 00:00:00'),(3,'Tranferência','Débito de Pontos','-',1,'0000-00-00 00:00:00'),(4,'Tranferência','Crédito de Pontos','+',1,'0000-00-00 00:00:00'),(5,'Troca','Débito de Pontos','-',1,'0000-00-00 00:00:00'),(6,'Troca','Crédito de Pontos','+',1,'0000-00-00 00:00:00');
...
INSERT INTO `bsc_tipo_bancario` VALUES (1,'Corrente'),(2,'Poupança');
...
INSERT INTO `seg_usuario` VALUES (2,1,'Rogério Moura Rosas','rojherio','rojheriorosas@gmail.com','','a050905511f0722fc20d2bdbfb499ca08d424c91','1988-06-19 05:00:00',NULL,'885.566.892-72','412549','SSP/AC','1','3','','','',NULL,NULL,'8802523556',NULL,'',1,'2016-07-27 03:51:01');
...
-- Dump completed on 2016-11-21 15:20:37
