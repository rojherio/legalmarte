...
INSERT INTO `acc_pessoa` VALUES (1,1,NULL,NULL,'Rojherio',1,'2016-07-19 22:26:25');
...
INSERT INTO `acc_pessoa_admin` VALUES (1,1,100.00,1);
/*!40000 ALTER TABLE `acc_pessoa_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acc_pessoa_bancario`
--

DROP TABLE IF EXISTS `acc_pessoa_bancario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acc_pessoa_bancario` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acc_pessoa_id` int(11) NOT NULL,
  ...
  `data_cadastro` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_acc_pessoa_bancario_acc_pessoa1_idx` (`acc_pessoa_id`),
  KEY `fk_acc_pessoa_bancario_bsc_banco1_idx` (`bsc_banco_id`),
  KEY `fk_acc_pessoa_bancario_bsc_tipo_bancario1_idx` (`bsc_tipo_bancario_id`),
  CONSTRAINT `fk_acc_pessoa_bancario_acc_pessoa1` FOREIGN KEY (`acc_pessoa_id`) REFERENCES `acc_pessoa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_acc_pessoa_bancario_bsc_banco1` FOREIGN KEY (`bsc_banco_id`) REFERENCES `bsc_banco` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_acc_pessoa_bancario_bsc_tipo_bancario1` FOREIGN KEY (`bsc_tipo_bancario_id`) REFERENCES `bsc_tipo_bancario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acc_pessoa_bancario`
--

LOCK TABLES `acc_pessoa_bancario` WRITE;
/*!40000 ALTER TABLE `acc_pessoa_bancario` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_pessoa_bancario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `seg_usuario` VALUES (1,1,'','Rojherio','rojheriorosas@gmail.com','','a050905511f0722fc20d2bdbfb499ca08d424c91','1988-06-07 05:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1338707539',NULL,1,'2016-07-19 22:26:25');
...
-- Dump completed on 2016-07-19 23:13:09
