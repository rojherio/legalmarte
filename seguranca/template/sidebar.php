  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="<? ConstantesSeguranca::$ASSETS_FOLDER ?>img/profiles/avatar.jpg"  alt="" data-src="<? ConstantesSeguranca::$ASSETS_FOLDER ?>img/profiles/avatar.jpg" data-src-retina="<? ConstantesSeguranca::$ASSETS_FOLDER ?>img/profiles/avatar2x.jpg" width="69" height="69" /> </div>
        <div class="user-info">
