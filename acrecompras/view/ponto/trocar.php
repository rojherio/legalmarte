              ...
              <div class="seus-pontos">
                ...
                <form method="post" action="">
                  ...
                  <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input class="form-control" type="text" disabled value="00.000.000.000/0001" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                      <img src="<?= ConstantesAcreCompras::$IMG_FOLDER; ?>company/indisponivel.jpg" border="0" width="100%" />
                    </div>
                  </div>
                  <br />
                  <div class="row">
